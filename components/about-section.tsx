...
const stats = [
    {icon: Monitor, value: "120+", label: "Игровых ПК", suffix: "", href: "#zones"},
    {icon: Trophy, value: "50+", label: "Турниров в год", suffix: "", href: "#tournaments"},
    {icon: Users, value: "5000+", label: "Активных игроков", suffix: "", href: "#rankings"},
    {icon: Zap, value: "3", label: "Класса зон", suffix: "", href: "#zones"},
]
