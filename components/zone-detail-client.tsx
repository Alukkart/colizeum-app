        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-12">
                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-lg font-semibold text-foreground mb-1">{component.model}</div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="text-sm text-muted-foreground mb-1">{categoryLabels[device.category]}</div>
                            <div className="text-lg font-semibold text-foreground mb-1">{device.model}</div>
              ...
              {/* CTA */}
              <div className="p-6 bg-gradient-to-r from-primary/20 to-primary/5 rounded-2xl border border-primary/30">
