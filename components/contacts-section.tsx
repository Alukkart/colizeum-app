          ...
          <span className="text-primary text-sm font-semibold tracking-widest uppercase mb-4 block">
            Связаться с нами
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    >
                        {/* Map Placeholder */}
                        <div className="relative h-full mb-6 rounded-xl overflow-hidden border border-border">
                            <iframe
                                src="https://yandex.ru/map-widget/v1/?display-text=Colizeum&ll=37.638350%2C55.772436&mode=search&oid=110653965536&ol=biz&sll=37.617700%2C55.755863&sspn=1.892395%2C1.003674&tab=gallery&text=%7B%22text%22%3A%22Colizeum%22%2C%22what%22%3A%5B%7B%22attr_name%22%3A%22chain_id%22%2C%22attr_values%22%3A%5B%22172689625016%22%5D%7D%5D%7D&z=17.38" allowFullScreen
