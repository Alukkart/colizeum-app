      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-foreground text-balance">Турниры и события</h2>
          </div>
            ...
            {filteredTournaments.map((tournament, index) => (
              ...
              >
                ...
                <div className="lg:col-span-2 flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-medium text-foreground">{formatDate(tournament.date)}</div>
