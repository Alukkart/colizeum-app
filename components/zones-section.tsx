...
import { Check, Monitor, Cpu, Headphones, ArrowRight } from "lucide-react"
...
const zones = [
  {
    ...
    specs: ["RTX 4060 Ti", "Intel i5-13400F", "144Hz монитор", "Игровая периферия"],
    price: "150₽/час",
  ...
  },
  {
    ...
    specs: ["RTX 4070 Ti", "Intel i7-13700K", "240Hz монитор", "Премиум периферия"],
    price: "250₽/час",
  ...
  },
  {
    ...
    specs: ["RTX 4090", "Intel i9-14900K", "360Hz монитор", "Элитная периферия"],
    price: "400₽/час",
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isHovered === zone.id ? "opacity-100" : "opacity-0",
                )}
              >
